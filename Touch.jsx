...
<div className="relative top-24 p-12">
   <div className="flex flex-col items-center">
      ...
      <p className="text-5 font-normal w-xl h-14 text-center pt-6">What’s next? Feel free to reach out to me if you're looking for a developer, have a query, or simply want to connect.</p>
      <div className="pt-12 ">
